...
class simulation_3Q():
	...
	# 		rho_lab = self.result_rho.states[ int(round((t - self.dTimeStart)/self.dt)) ]
	...
	# def generateMeasurementRho(self):
	# 	sPre = 'Time Series: '
	# 	self.dict_Pauli2 = {}
	# 	self.dict_StateFinal = {}
	# 	self.dict_StateFinal['Final Pauli-16'] = []
	...
	def generateFinalRho(self):
		...
		self.final_pauli16 = [np.real((op * rho_logic).tr()) for op in dict_pauli16.values()]
	...
	def generateFinalPsi(self):
		...
		# log.info(type(self.final_state))
		# log.info(type(self.final_pauli16))
