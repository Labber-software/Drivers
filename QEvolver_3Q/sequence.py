...
class sequence():
	...
	# 	return 0.5 * args.capCfg.r12 * np.sqrt(self.timeFunc_Q1_Frequency(t,args) * self.timeFunc_Q2_Frequency(t,args))

	# def	timeFunc_g23_pp(t,args=None):
	# 	return 0.5 * args.capCfg.r23 * np.sqrt(self.timeFunc_Q2_Frequency(t,args) * self.timeFunc_Q3_Frequency(t,args))

	# def	timeFunc_g13_pp(t,args=None):
	# 	return 0.5 * args.capCfg.r13 * np.sqrt(self.timeFunc_Q1_Frequency(t,args) * self.timeFunc_Q3_Frequency(t,args))
